package com.example.rabit_booking_consumer.configuration;
...
public class RabbitConfiguration {
    ...
    //Bind message exchange and booking exchange with the routing key from the properties file- message.routingKey - used in above audit binding
    @Bean
